...
public class LunchMenuforp extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					LunchMenuforp frame = new LunchMenuforp();
	...
	public LunchMenuforp() {
		...
		scrollPane.setBounds(39, 163, 529, 104);
		...
		JLabel lblNewLabel = new JLabel("Lunch Menu");
