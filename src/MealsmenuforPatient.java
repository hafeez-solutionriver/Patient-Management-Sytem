...
public class MealsmenuforPatient extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					MealsmenuforPatient frame = new MealsmenuforPatient();
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				dispose();
				BreakFastforp bp= new BreakFastforp();
				bp.setVisible(true);
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				dispose();
				LunchMenuforp lp = new LunchMenuforp();
				lp.setVisible(true);
		...
		button_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				dispose();
				dinnerMenuforp dp = new dinnerMenuforp();
				dp.setVisible(true);
			}
		});
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				dispose();
				PatientmenuforP dm = new PatientmenuforP();
				dm.setVisible(true);
			}
		});
